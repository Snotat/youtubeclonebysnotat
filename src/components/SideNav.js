...
function SideNav() {
    const { loading, mobileMenu, setMobileMenu, theme, setTheme, setSide, side } =
    ...
    return (
        <div className=" small w-full flex h-full flex-row">
            <div className="small w-60 float-left dark:bg-black dark:text-white  text-gray-700  scroll-smooth overflow-y-scroll overflow-x-hidden bg-white flex-col pr-2">

                <div className="flex p-5 pl-6 sticky top-0 dark:bg-black bg-white">  <RxHamburgerMenu onClick={sideToggle} className="flex w-6 h-6 dark:text-white" />   <Link to="/" className="flex h-4 align-middle items-center">
                    <FaYoutube className="flex w-8 h-8 ml-5 text-red-600" />
                    <span className="flex ml-1 text-lg font-bold dark:text-gray-100">YouTube</span>
                </Link>
                </div>
                <div className="flex p-3 pt-1 flex-col">
                    ...
                    <div className="flex bg mb-1 bg-black/5 p-3 rounded-xl w-full "><SiYoutubeshorts className='w-5 h-5' /><span className='pl-6 align-middle self-center text-sm font-semibold'>Shorts</span></div>
                ...
                <hr className='bg-gray-300 hover:bg-gray-400  dark:bg-gray-800 dark:hover:hover:bg-gray-700  w-full' />
                ...
                <hr className='bg-gray-300 hover:bg-gray-400  dark:bg-gray-800 dark:hover:bg-gray-700  w-full' />
           ...
           break-normal text-sm font-semibold pr-2">Sign in</span>
                ...
                <hr className='w-full bg-black/70' />
            ...
            <div onClick={sideToggle} className="w-[calc(100%-15rem)] h-full bg-black/25 flex"></div>
        </div>
    )
}
