...
const LargeNav = () => {
    ...
    return (
        <div
            className={`w-16 sticky px-2 pt-4 top-0 h-[100vh] bg-white overflow-y-hidden z-30 overflow-hidden  transition-all "
        }`}
        >
            <RxHamburgerMenu onClick={sideToggle} className="flex w-5 h-5 dark:text-white mb-8 mt-1 ml-4" />
